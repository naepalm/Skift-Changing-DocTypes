...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "eab419d6d1951d47")]
...
#pragma warning restore 0109
		...
		///<summary>
		/// Banner: The banner image that displays on the top of the page. Make it nice and big; we'll crop it for you!
		///</summary>
		...
		///<summary>
		/// Content: Free-flowing rich text content on the page. You can insert images, headlines, and basic text styles!
		///</summary>
		...
		///<summary>
		/// Headline: Displays at the top of the page over the banner! If left blank, the page name will be used.
		///</summary>
...
#pragma warning restore 0109
		...
		///<summary>
		/// Banner: Add a banner image and some text to really make your landing page pop! Make sure the image is SUPER BIG. We'll crop it ;)
		///</summary>
		[ImplementPropertyType("banner")]
		...
		///<summary>
		/// Content: Add images, quotes, and more via the grid to have a flashy, dynamic landing page!
		///</summary>
